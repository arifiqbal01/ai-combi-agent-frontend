...
export function ComposerEditor({
  ...
  useEffect(() => {
    ...
    // ✅ ensure single adapter instance
    if (!adapterRef.current) {

      const adapter = new TipTapAdapter(editor)

      // 🔥 ensure adapter supports setContent
      if (typeof adapter.replaceContent !== 'function') {
          console.error('❌ TipTapAdapter missing replaceContent()')
        }
